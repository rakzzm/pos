...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   GET: () => (/* binding */ GET),\n/* harmony export */   POST: () => (/* binding */ POST)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/next/dist/api/server.js\");\n/* harmony import */ var _lib_prisma__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../lib/prisma */ \"(rsc)/./src/lib/prisma.ts\");\n\n\nasync function GET() {\n    try {\n        const staff = await _lib_prisma__WEBPACK_IMPORTED_MODULE_1__.prisma.staff.findMany({\n            include: {\n                leaveRequests: true,\n                attendanceRecords: true\n            },\n            orderBy: {\n                createdAt: 'desc'\n            }\n        });\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(staff);\n    } catch (error) {\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            error: 'Failed to fetch staff'\n        }, {\n            status: 500\n        });\n    }\n}\nasync function POST(request) {\n    try {\n        const body = await request.json();\n        const staff = await _lib_prisma__WEBPACK_IMPORTED_MODULE_1__.prisma.staff.create({\n            data: {\n                employeeId: body.employeeId || `EMP${Math.floor(Math.random() * 10000)}`,\n                name: body.name,\n                email: body.email,\n                phone: body.phone,\n                position: body.position,\n                department: body.department,\n                hireDate: body.hireDate ? new Date(body.hireDate) : new Date(),\n                salary: parseFloat(body.salary),\n                status: body.status || 'active',\n                leaveBalanceAnnual: body.leaveBalance?.annual || 14,\n                leaveBalanceSick: body.leaveBalance?.sick || 14,\n                leaveBalancePersonal: body.leaveBalance?.personal || 7,\n                performanceRating: body.performanceRating || 0,\n                lastReview: body.lastReview ? new Date(body.lastReview) : null\n            }\n        });\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(staff);\n    } catch (error) {\n        console.error('Error creating staff:', error);\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            error: 'Failed to create staff'\n        }, {\n            status: 500\n        });\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./src/app/api/staff/route.ts\n");
